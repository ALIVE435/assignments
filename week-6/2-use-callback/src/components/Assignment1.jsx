...
export function Assignment1() {
    ...
    const handleIncrement=useCallback(function (){  //when we pass empty dependencies array, the function is declared only once on 1st rendering or we can say it's reference remain same even after this component is rendered again(function is invoked again)
